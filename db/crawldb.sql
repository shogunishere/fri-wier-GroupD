...
SELECT pg_catalog.setval('crawldb.image_id_seq', 2386, true);
...
SELECT pg_catalog.setval('crawldb.page_id_seq', 43751, true);
...
SELECT pg_catalog.setval('crawldb.site_id_seq', 462, true);
